...
copy "%UserProfile%\AMD Media SDK\1.1\dll\amf\x86\release\vs12\amf-core-windesktop.dll" .\
copy "%UserProfile%\AMD Media SDK\1.1\dll\amf\x86\release\vs12\amf-component-vce-windesktop.dll" .\
